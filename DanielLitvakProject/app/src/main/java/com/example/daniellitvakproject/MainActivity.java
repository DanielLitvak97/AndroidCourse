...
private String language;
    ...
    public void login(String language){
        ...
        if(email.isEmpty() || password.isEmpty()){
            if ("Hebrew".equals(language)) {
                Toast.makeText(MainActivity.this, "נא להזין אימייל וסיסמה", Toast.LENGTH_LONG).show();
            } else {
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            if ("Hebrew".equals(language)) {
                                Toast.makeText(MainActivity.this, "ההרשמה הצליחה", Toast.LENGTH_LONG).show();
                            } else {
                            ...
                            if ("Hebrew".equals(language)) {
                                Toast.makeText(MainActivity.this, "ההרשמה נכשלה", Toast.LENGTH_LONG).show();
                            } else {
    ...
    public void sendComment(String animalId, String commentText) {
        ...
        if ("Hebrew".equals(language)) {
            Toast.makeText(MainActivity.this, "התגובה נוספה", Toast.LENGTH_LONG).show();
        } else {
